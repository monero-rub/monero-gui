...
QtObject {
    ...
    property string errorColor: "#6800FA"
    ...
    property string buttonBackgroundColor: "#6800FA"
    property string buttonBackgroundColorHover: "#5E00E6"
