...
QtObject {
    ...
    property string errorColor: "#8D52B2"
    ...
    property string buttonBackgroundColor: "#8D52B2"
    property string buttonBackgroundColorHover: "#8D52B2"
