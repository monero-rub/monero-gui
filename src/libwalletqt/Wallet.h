...
public:
    ...
    //! returns balance
    Q_INVOKABLE double balance(quint32 accountIndex) const;
    Q_INVOKABLE double balanceAll() const;

    //! returns unlocked balance
    Q_INVOKABLE double unlockedBalance(quint32 accountIndex) const;
    Q_INVOKABLE double unlockedBalanceAll() const;
